...
public class RankAdapter extends RecyclerView.Adapter<RankAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtRank = itemView.findViewById(R.id.tvRankNumber);
            txtName = itemView.findViewById(R.id.tvRankName);
            txtPoints = itemView.findViewById(R.id.tvRankPoints);
            imgAvatar = itemView.findViewById(R.id.imgRankAvatar); // bind ImageView
        }
    }
}
